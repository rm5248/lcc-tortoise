...
# Flash the main code
"$STM32_CLI" -c port=swd -w build/lcc-io32-plus/zephyr/lcc-io32-plus.signed.bin 0x0800C000
# Flash the bootloader
"$STM32_CLI" -c port=swd -w build/mcuboot/zephyr/lcc-io32-plus-bootloader.bin 0x08000000
# Start it up
